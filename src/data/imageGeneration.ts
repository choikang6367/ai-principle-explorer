...
export const imageDenoiseSteps = [
  ...
  },
  {
    ...
    description: '장소와 분위기 단서를 참고해 하늘과 바닥처럼 넓은 색 영역만 거칠게 나눠요. 아직 주인공은 알아볼 수 없어요.',
    imagePath: 'images/image-generation/02-color-blocks.svg',
    alt: '짙은 하늘과 밝은 바닥처럼 큰 색 영역이 나뉘기 시작한 교육용 그림',
    revealPercent: 15,
    activeParts: ['place', 'mood'],
  },
  {
    id: 'subject-shape',
    shortLabel: '주인공',
    title: '주인공이 있을 자리가 생겨요',
    description: '주인공과 행동 단서가 화면에서 차지할 위치와 크기를 잡아요. 형태는 아직 흐릿한 덩어리예요.',
    imagePath: 'images/image-generation/03-subject-shape.svg',
    alt: '그림 가운데에 단순한 주인공 모양이 나타난 교육용 단계 그림',
    revealPercent: 35,
    activeParts: ['subject', 'scene'],
  },
  {
    id: 'outline',
    shortLabel: '윤곽',
    title: '윤곽과 물건의 모양을 정리해요',
    description: '완성 이미지에서 실제 경계선을 찾아 주인공, 물건, 지형의 윤곽을 연결해요. 색과 질감은 아직 약해요.',
  ...
  },
  {
    ...
    description: '장소 단서를 먼저 선명하게 펼치고, 주인공 영역은 흐리게 남겨 배경과 앞뒤 깊이를 확인해요.',
  ...
  },
  {
    ...
    shortLabel: '세부',
    title: '세부 묘사와 색을 더해요',
    description: '같은 완성 이미지 위에 스타일과 분위기 단서가 만든 빛, 재질, 작은 무늬를 복원해요.',
    imagePath: 'images/image-generation/06-details.svg',
    alt: '주인공과 배경에 빛과 작은 무늬가 더해진 교육용 단계 그림',
    revealPercent: 90,
    activeParts: ['style', 'mood'],
  },
  {
    id: 'final',
    shortLabel: '완성',
    title: '같은 장면의 완성 결과를 확인해요',
    description: '앞 단계와 같은 구도의 원본 결과를 노이즈, 흐림, 윤곽 필터 없이 보여 줘요. 실제 모델의 내부 화면을 그대로 보여 주는 것은 아니에요.',
    imagePath: 'images/image-generation/results/moon-cat-storybook-v2.jpg',
    alt: '우주복을 입은 고양이가 달 표면에서 깃발을 든 정교한 동화책 완성 그림 예시',
    revealPercent: 100,
    activeParts: ['subject', 'scene', 'place', 'style', 'mood'],
  },
